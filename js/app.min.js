...
define('text!templates/common/header.html',[],function () { return '<nav class="navbar navbar-default <% if(Backbone.history.fragment.indexOf(\'admin\') > -1 && logged_in) print(\'margin-bottom-20\') %>">\r\n    <div class="container">\r\n        <!-- Brand and toggle get grouped for better mobile display -->\r\n        <div class="navbar-header">\r\n            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false">\r\n                <span class="sr-only">Toggle navigation</span>\r\n                <span class="icon-bar"></span>\r\n                <span class="icon-bar"></span>\r\n                <span class="icon-bar"></span>\r\n            </button>\r\n            <a class="navbar-brand" href="#">Exo</a>\r\n        </div>\r\n\r\n        <!-- Collect the nav links, forms, and other content for toggling -->\r\n        <div class="collapse navbar-collapse" id="navbar-collapse">\r\n            <% if (Backbone.history.fragment.indexOf(\'admin\') > -1 && logged_in) { %>\r\n                <ul class="nav navbar-nav">\r\n                    <li><a href="#admin/banners">Banners</a></li>\r\n                    <li><a href="#admin/blogs">Blogs</a></li>\r\n                    <li><a href="#admin/config">Configuration</a></li>\r\n                    <li><a href="#admin/menus">Menus</a></li>\r\n                    <li><a href="#admin/pages">Pages</a></li>\r\n                    <li><a href="#admin/portfolios">Portfolios</a></li>\r\n                    <li><a href="#admin/services">Services</a></li>\r\n                    <li><a href="#admin/testimonials">Testimonials</a></li>\r\n                </ul>\r\n            <% } else { %>\r\n                <ul class="nav navbar-nav">\r\n                    <li class="active"><a href="#">Home</a></li>\r\n                    <li><a href="#">Services</a></li>\r\n                    <li><a href="#">Portfolio</a></li>\r\n                    <li><a href="#">Contact us</a></li>\r\n                    <li><a href="#">Blog</a></li>\r\n                </ul>\r\n            <% } %>\r\n\r\n            <% if (logged_in) { %>\r\n                <ul class="nav navbar-nav navbar-right">\r\n                    <li class="dropdown">\r\n                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-bypass="true"><%= email %> <span class="caret"></span></a>\r\n                        <ul class="dropdown-menu">\r\n                            <li><a href="#admin/config">Admin</a></li>\r\n                            <li><a href="#" id="logout" data-bypass="true">Logout</a></li>\r\n                        </ul>\r\n                    </li>\r\n                </ul>\r\n            <% } %>\r\n        </div>\r\n    </div>\r\n</nav>';});
...
define('text!templates/common/footer.html',[],function () { return '<div class="footer-container">\r\n    <div class="container clearfix">\r\n        <div class="col-md-3 copyright">Copyright Exo @ 2013</div>\r\n        <div class="col-md-9">\r\n            <ul class="nav nav-pills pull-right">\r\n                <li><a href="#">Home</a></li>\r\n                <li><a href="#">Services</a></li>\r\n                <li><a href="#">Portfolio</a></li>\r\n                <li><a href="#">Blog</a></li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>';});
...
define('text!templates/uploads/attachable.html',[],function () { return '<input name="image" type="file" id="image" class="form-control">\r\n<input name="filename" type="hidden" id="filename" class="form-control" value="<%= data.filename %>">\r\n<p class="help-block"></p>\r\n\r\n<div id="upload-image-container">\r\n\t<% if(data.filename) { %>\r\n\t\t<img src="<%= App.URL %>/files/<%= location %><%= data.filename %>" alt="">\r\n\t\t<a href="#" id="deleteImage">x</a>\r\n\t<% } %>\r\n</div>';});

define('views/uploads/attachable',[
	'app',
...
define('text!templates/errors/404.html',[],function () { return '<h2>404 Error</h2><br>\r\n<p><%= page %> not found</p>';});

define('views/errors/404',[
    'app',
...
define('text!templates/users/login.html',[],function () { return '<div class="login-container container">\r\n\t<div class="login-logo"></div>\r\n\t<div class="login-form-container">\r\n\t\t<h1>Login to Exo</h1>\r\n\t\t<form id="UserLoginForm">\r\n\t\t\t<div class="form-group">\r\n\t\t\t\t<input name="email" maxlength="250" type="email" id="email" class="form-control">\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class="form-group">\r\n\t\t\t\t<input name="password" type="password" id="password" class="form-control">\r\n\t\t\t</div>\r\n\r\n\t\t\t<button type="button" class="btn btn-default" id="signin"> Sign In <i class="fa fa-sign-in"></i> </button>\r\n\t\t</form>\r\n\t</div>\r\n</div>';});

define('views/users/login',[
	'app',
...
define('collections/BannersCollection',[
	'models/BannerModel',
	'app',
...
define('text!templates/banners/admin_list.html',[],function () { return '<td><img src="<%= App.URL %>/files/banners/<%= filename %>" width="100" height="100" alt=""></td>\r\n<td><%= title %></td>\r\n<td><%= url %></td>\r\n<td>\r\n\t<a href="#" class="delete btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>\r\n</td>';});

define('views/banners/admin_list',[
	'app',
...
define('text!templates/banners/admin_index.html',[],function () { return '<a href="#admin/banners/add" class="btn btn-success pull-right"><span>New Banner</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Image</th>\r\n\t\t\t\t<th>Title</th>\r\n\t\t\t\t<th>URL</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/banners/admin_index',[
	'app',
...
define('text!templates/banners/admin_add.html',[],function () { return '<h2>Add Banner</h2> <br>\r\n\r\n<form id="addBanner" enctype="multipart/form-data">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Image</label>\r\n\t\t\t<input name="filename" type="file" id="filename" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control"></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Url</label>\r\n\t\t\t<input name="url" type="text" id="url" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitBanner">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/banners/admin_add',[
	'app',
...
define('collections/MenusCollection',[
	'models/MenuModel',
	'app',
...
define('text!templates/menus/admin_list.html',[],function () { return '<td><%= Parent.title %></td>\r\n<td><%= title %></td>\r\n<td><%= controller %></td>\r\n<td><%= action %></td>\r\n<td>\r\n\t<%\r\n\t\tif(parseInt(status_id) === 1) {\r\n\t\t\tvar dataStatus = 2,\r\n\t\t\t\tclassName = \'btn-success\';\r\n\t\t} else {\r\n\t\t\tvar dataStatus = 1,\r\n\t\t\t\tclassName = \'btn-warning\';\r\n\t\t}\r\n\t%>\r\n\t<a href="#" class="status btn <%= className %>" data-status="<%= dataStatus %>">\r\n\t\t<% if (parseInt(status_id) === 1) { %>\r\n\t\t    Active\r\n\t\t<% } else { %>\r\n\t\t\tNot Active\r\n\t\t<% } %>\r\n\t</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/menus/admin_list',[
	'app',
...
define('text!templates/menus/admin_index.html',[],function () { return '<a href="#admin/menus/add" class="btn btn-success pull-right"><span>New Menu</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Parent</th>\r\n\t\t\t\t<th>Title</th>\r\n\t\t\t\t<th>Controller</th>\r\n\t\t\t\t<th>Action</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/menus/admin_index',[
	'app',
...
define('text!templates/menus/admin_add.html',[],function () { return '<h2>Add Menu</h2> <br>\r\n\r\n<form id="addMenu">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Parent</label>\r\n\t\t\t<select name="parent_id" id="parent_id" class="form-control">\r\n\t\t\t\t<option value="" selected="selected">Select Parent</option>\r\n\t\t\t\t<% _.each(parents, function(value, key) { %>\r\n\t\t\t\t    <option value="<%= key %>"><%= value %></option>\r\n\t\t\t\t<% }); %>\r\n\t\t\t</select>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Controller</label>\r\n\t\t\t<input name="controller" type="text" id="controller" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Action</label>\r\n\t\t\t<input name="action" type="text" id="action" class="form-control">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitBanner">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/menus/admin_add',[
	'app',
...
define('collections/ConfigsCollection',[
	'models/ConfigModel',
	'app',
...
define('text!templates/configs/admin_edit.html',[],function () { return '<h2>Configuration Settings</h2> <br>\r\n\r\n<form id="editConfig">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Email</label>\r\n\t\t\t<input name="email" type="email" id="email" class="form-control" value="<%= email %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Host</label>\r\n\t\t\t<input name="host" type="text" id="host" class="form-control" value="<%= host %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Username</label>\r\n\t\t\t<input name="username" type="text" id="username" class="form-control" value="<%= username %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Password</label>\r\n\t\t\t<input name="password" type="password" id="password" class="form-control" value="<%= password %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Port</label>\r\n\t\t\t<input name="port" type="text" id="port" class="form-control" value="<%= port %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Powered By</label>\r\n\t\t\t<input name="powered_by" type="text" id="powered_by" class="form-control" value="<%= powered_by %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Copyright</label>\r\n\t\t\t<input name="copyright" type="text" id="copyright" class="form-control" value="<%= copyright %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitConfig">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/configs/admin_edit',[
	'app',
...
define('collections/BlogsCollection',[
	'models/BlogModel',
	'app',
...
define('text!templates/blogs/admin_list.html',[],function () { return '<td><%= title %></td>\r\n<td><%= _.truncate(description, 100) %></td>\r\n<td><img src="<%= App.URL %>/files/blogs/<%= filename %>" alt="" width="100" height="100"></td>\r\n<td>\r\n\t<%\r\n\t\tif(parseInt(status_id) === 1) {\r\n\t\t\tvar dataStatus = 2,\r\n\t\t\t\tclassName = \'btn-success\';\r\n\t\t} else {\r\n\t\t\tvar dataStatus = 1,\r\n\t\t\t\tclassName = \'btn-warning\';\r\n\t\t}\r\n\t%>\r\n\t<a href="#admin/blogs/edit/<%= id %>" class="btn btn-info">Edit</a>\r\n\t<a href="#" class="status btn <%= className %>" data-status="<%= dataStatus %>">\r\n\t\t<% if (parseInt(status_id) === 1) { %>\r\n\t\t    Active\r\n\t\t<% } else { %>\r\n\t\t\tNot Active\r\n\t\t<% } %>\r\n\t</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/blogs/admin_list',[
	'app',
...
define('text!templates/blogs/admin_index.html',[],function () { return '<a href="#admin/blogs/add" class="btn btn-success pull-right"><span>New Blog</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Title</th>\r\n\t\t\t\t<th width="50%">Description</th>\r\n\t\t\t\t<th>Image</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/blogs/admin_index',[
	'app',
...
define('text!templates/blogs/admin_add.html',[],function () { return '<h2>Blog</h2> <br>\r\n\r\n<form id="addBlog">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control" value="<%= title %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control ckeditor"><%= description %></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group" id="imageContainer">\r\n\t\t\t<label>Image</label>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitBlog">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/blogs/admin_add',[
	'app',
...
define('collections/PagesCollection',[
	'models/PageModel',
	'app',
...
define('text!templates/modals/contact.html',[],function () { return '<div class="modal fade" tabindex="-1" role="dialog">\r\n    <div class="modal-dialog">\r\n        <div class="modal-content">\r\n            <div class="modal-header">\r\n                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\r\n                <h4 class="modal-title"><%= title %></h4>\r\n            </div>\r\n\r\n            <div class="modal-body">\r\n                <p><%= description %></p>\r\n                </div>\r\n                <div class="modal-footer">\r\n                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\r\n                <button type="button" class="btn btn-primary">Save changes</button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>';});

define('views/modals/contact',[
    'app',
...
define('text!templates/pages/home.html',[],function () { return '<!-- banner -->\r\n<div id="carousel" class="main-sections carousel slide" data-ride="carousel">\r\n    <!-- Indicators -->\r\n    <ol class="carousel-indicators">\r\n        <% _.times(banners.length, function(n) { %>\r\n            <li data-target="#carousel" data-slide-to="<%= n %>" class="<% (n === 0) ? print(\'active\') : \'\' %>"></li>\r\n        <% }); %>\r\n    </ol>\r\n\r\n    <!-- Wrapper for slides -->\r\n    <div class="carousel-inner" role="listbox">\r\n        <% var count = 1; %>\r\n        <% _.each(banners, function(item) { %>\r\n            <div class="item <% (count === 1) ? print(\'active\') : \'\' %>">\r\n                <img src="<%= App.URL %>/files/banners/<%= item.Banner.filename %>" alt="">\r\n                <div class="carousel-caption">\r\n                    <h1><%= item.Banner.title %></h1>\r\n                </div>\r\n            </div>\r\n            <% count++; %>\r\n        <% }); %>\r\n    </div>\r\n\r\n    <% if(banners.length > 1) { %>\r\n        <!-- Controls -->\r\n        <a class="left carousel-control" href="#carousel" role="button" data-slide="prev" data-bypass="true">\r\n            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>\r\n            <span class="sr-only">Previous</span>\r\n        </a>\r\n\r\n        <a class="right carousel-control" href="#carousel" role="button" data-slide="next" data-bypass="true">\r\n            <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>\r\n            <span class="sr-only">Next</span>\r\n        </a>\r\n    <% } %>\r\n</div>\r\n\r\n<!-- Services -->\r\n<div class="main-sections services-container text-center container">\r\n    <h2><%= pages[0].Page.title %></h2>\r\n    <p><%= pages[0].Page.description %></p>\r\n\r\n    <div class="row">\r\n        <% _.each(services, function(item) { %>\r\n            <div class="col-sm-6 col-md-4">\r\n                <div class="thumbnail">\r\n                    <img src="<%= App.URL %>/files/services/<%= item.Service.filename %>" alt="">\r\n                    <div class="caption">\r\n                        <h3><%= item.Service.title %></h3>\r\n                        <p><%= _.truncate(item.Service.description, 100) %></p>\r\n                        <p><a href="/services/<%= item.Service.url %>" class="btn btn-primary" role="button">Button</a></p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        <% }); %>\r\n    </div>\r\n</div>\r\n\r\n<!-- Portfolio -->\r\n<div class="main-sections portfolio-container">\r\n    <div class="portfolio-page text-center">\r\n        <h2><%= pages[1].Page.title %></h2>\r\n        <p><%= pages[1].Page.description %></p>\r\n    </div>\r\n\r\n    <div class="portfolio-body container">\r\n        <div class="row">\r\n            <% _.each(portfolios, function(item) { %>\r\n                <div class="col-sm-6 col-md-4">\r\n                    <div class="thumbnail">\r\n                        <a href="<%= item.Portfolio.url %>" target="_blank">\r\n                            <img src="<%= App.URL %>/files/portfolios/<%= item.Portfolio.filename %>" alt="">\r\n                            <div class="caption">\r\n                                <h3><%= item.Portfolio.title %></h3>\r\n                                <p><%= _.truncate(item.Portfolio.description, 100) %></p>\r\n                            </div>\r\n                        </a>\r\n                    </div>\r\n                </div>\r\n            <% }) %>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n<!-- Testimonials -->\r\n<div class="main-sections testimonail-container" style="background-image: url(\'<%= App.URL %>/files/pages/<%= pages[2].Page.filename %>\');">\r\n    <div class="testimonial-page container text-center">\r\n        <h2><%= pages[2].Page.title %></h2>\r\n        <p><%= pages[2].Page.description %></p>\r\n    </div>\r\n\r\n    <div class="container">\r\n        <div id="testimonail-carousel" class="carousel slide" data-ride="carousel">\r\n            <!-- Indicators -->\r\n            <ol class="carousel-indicators">\r\n                <% _.times(testimonials.length, function(n) { %>\r\n                    <li data-target="#testimonail-carousel" data-slide-to="<%= n %>" class="<% (n === 0) ? print(\'active\') : \'\' %>"></li>\r\n                <% }); %>\r\n            </ol>\r\n\r\n            <!-- Wrapper for slides -->\r\n            <div class="carousel-inner" role="listbox">\r\n                <% var count = 1; %>\r\n                <% _.each(testimonials, function(item) { %>\r\n                    <div class="item <% (count === 1) ? print(\'active\') : \'\' %>">\r\n                        <div class="carousel-caption clearfix">\r\n                            <p><%= item.Testimonial.description %></p>\r\n                            <div class="col-md-push-4 col-md-4 author">\r\n                                <img src="<%= App.URL %>/files/testimonials/<%= item.Testimonial.filename %>" alt="">\r\n                                <span><%= item.Testimonial.author %></span>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                    <% count++; %>\r\n                <% }) %>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n<!-- Blogs -->\r\n<div class="main-sections blogs-container">\r\n    <div class="text-center">\r\n        <h2><%= pages[3].Page.title %></h2>\r\n        <p><%= pages[3].Page.description %></p>\r\n    </div>\r\n\r\n    <div class="container">\r\n        <div class="row">\r\n            <% _.each(blogs, function(item) { %>\r\n                <div class="col-sm-6 col-md-4">\r\n                    <div class="thumbnail">\r\n                        <a href="blogs/<%= item.Blog.url %>">\r\n                            <img src="<%= App.URL %>/files/blogs/<%= item.Blog.filename %>" alt="">\r\n                            <div class="caption">\r\n                                <h3><%= item.Blog.title %></h3>\r\n                                <p><%= _.truncate(item.Blog.description, 100) %></p>\r\n                            </div>\r\n                        </a>\r\n                    </div>\r\n                </div>\r\n            <% }) %>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n<!-- contact us -->\r\n<div class="contact-container" style="background-image: url(\'<%= App.URL %>/files/pages/<%= pages[4].Page.filename %>\');">\r\n    <div class="text-center">\r\n        <h2><%= pages[4].Page.title %></h2>\r\n        <p><%= pages[4].Page.description %></p>\r\n    </div>\r\n\r\n    <div class="container">\r\n        <form class="col-md-8 col-md-push-2 text-center">\r\n            <div class="form-group">\r\n                <input type="text" class="form-control" id="name" placeholder="Name">\r\n                <p class="help-block"></p>\r\n            </div>\r\n            <div class="form-group">\r\n                <input type="email" class="form-control" id="email" placeholder="Email">\r\n                <p class="help-block"></p>\r\n            </div>\r\n            <div class="form-group">\r\n                <textarea id="message" class="form-control" placeholder="Message"></textarea>\r\n                <p class="help-block"></p>\r\n            </div>\r\n            <button id="quickContact" class="btn btn-default">Send Message</button>\r\n        </form>\r\n    </div>\r\n</div>';});
...
define('text!templates/pages/admin_list.html',[],function () { return '<td><%= title %></td>\r\n<td><%= _.truncate(description, 100) %></td>\r\n<td><img src="<%= App.URL %>/files/pages/<%= filename %>" alt="" width="100" height="100"></td>\r\n<td>\r\n\t<a href="#admin/pages/edit/<%= id %>" class="btn btn-info">Edit</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/pages/admin_list',[
	'app',
...
define('text!templates/pages/admin_index.html',[],function () { return '<a href="#admin/pages/add" class="btn btn-success pull-right"><span>New Page</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Page</th>\r\n\t\t\t\t<th width="50%">Description</th>\r\n\t\t\t\t<th>Banner</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/pages/admin_index',[
	'app',
...
define('text!templates/pages/admin_add.html',[],function () { return '<h2>Page</h2> <br>\r\n\r\n<form id="addPage">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control" value="<%= title %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control"><%= description %></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group" id="imageContainer">\r\n\t\t\t<label>Image</label>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitPage">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/pages/admin_add',[
	'app',
...
define('collections/PortfoliosCollection',[
...
define('text!templates/portfolios/admin_list.html',[],function () { return '<td><%= title %></td>\r\n<td><%= description %></td>\r\n<td><img src="<%= App.URL %>/files/portfolios/<%= filename %>" alt="" width="100" height="100"></td>\r\n<td>\r\n\t<a href="#admin/portfolios/edit/<%= id %>" class="btn btn-info">Edit</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/portfolios/admin_list',[
	'app',
...
define('text!templates/portfolios/admin_index.html',[],function () { return '<a href="#admin/portfolios/add" class="btn btn-success pull-right"><span>New Portfolio</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Title</th>\r\n\t\t\t\t<th width="50%">Description</th>\r\n\t\t\t\t<th>Image</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/portfolios/admin_index',[
	'app',
...
define('text!templates/portfolios/admin_add.html',[],function () { return '<h2>Portfolio</h2> <br>\r\n\r\n<form id="addPortfolio">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control" value="<%= title %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control"><%= description %></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group" id="imageContainer">\r\n\t\t\t<label>Image</label>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitPortfolio">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/portfolios/admin_add',[
	'app',
...
define('collections/ServicesCollection',[
	'models/ServiceModel',
	'app',
...
define('text!templates/services/admin_list.html',[],function () { return '<td><%= title %></td>\r\n<td><%= description %></td>\r\n<td><img src="<%= App.URL %>/files/services/<%= filename %>" alt="" width="100" height="100"></td>\r\n<td>\r\n\t<a href="#admin/services/edit/<%= id %>" class="btn btn-info">Edit</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/services/admin_list',[
	'app',
...
define('text!templates/services/admin_index.html',[],function () { return '<a href="#admin/services/add" class="btn btn-success pull-right"><span>New Service</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Title</th>\r\n\t\t\t\t<th width="40%">Description</th>\r\n\t\t\t\t<th>Image</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/services/admin_index',[
	'app',
...
define('text!templates/services/admin_add.html',[],function () { return '<h2>Service</h2> <br>\r\n\r\n<form id="addService">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Title</label>\r\n\t\t\t<input name="title" type="text" id="title" class="form-control" value="<%= title %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control"><%= description %></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group" id="imageContainer">\r\n\t\t\t<label>Image</label>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitService">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/services/admin_add',[
	'app',
...
define('models/TestimonialModel',[
	'app',
], function (App) {
	'use strict';
...
define('collections/TestimonialsCollection',[
...
define('text!templates/testimonials/admin_list.html',[],function () { return '<td><%= author %></td>\r\n<td><%= description %></td>\r\n<td><img src="<%= App.URL %>/files/testimonials/<%= filename %>" alt="" width="100" height="100"></td>\r\n<td>\r\n\t<a href="#admin/testimonials/edit/<%= id %>" class="btn btn-info">Edit</a>\r\n\t<a href="#" class="delete btn btn-danger">Delete</a>\r\n</td>';});

define('views/testimonials/admin_list',[
	'app',
...
define('text!templates/testimonials/admin_index.html',[],function () { return '<a href="#admin/testimonials/add" class="btn btn-success pull-right"><span>New Testimonial</span></a>\r\n\r\n<div class="clearfix"></div><br><br>\r\n\r\n<div class="table-responsive">\r\n\t<table class="table table-striped">\r\n\t\t<thead>\r\n\t\t\t<tr>\r\n\t\t\t\t<th>Author</th>\r\n\t\t\t\t<th width="50%">Description</th>\r\n\t\t\t\t<th>Image</th>\r\n\t\t\t\t<th>Actions</th>\r\n\t\t\t</tr>\r\n\t\t</thead>\r\n\r\n\t\t<tbody>\r\n\t\t</tbody>\r\n\t</table>\r\n</div>';});

define('views/testimonials/admin_index',[
	'app',
...
define('text!templates/testimonials/admin_add.html',[],function () { return '<h2>Testimonial</h2> <br>\r\n\r\n<form id="addTestimonial">\r\n\t<fieldset>\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Auhtor</label>\r\n\t\t\t<input name="author" type="text" id="author" class="form-control" value="<%= author %>">\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\r\n\t\t<div class="form-group">\r\n\t\t\t<label>Description</label>\r\n\t\t\t<textarea name="description" id="description" class="form-control"><%= description %></textarea>\r\n\t\t\t<p class="help-block"></p>\r\n\t\t</div>\r\n\t\t<script type="text/javascript">\r\n\t\t\tCKEDITOR.replace( \'description\', {\r\n\t\t\t\ttoolbar: [\r\n\t\t\t\t\t{ name: \'document\', items : [ \'Source\',\'NewPage\',\'Preview\' ] },\r\n\t\t            { name: \'basicstyles\', items : [ \'Bold\',\'Italic\',\'Underline\',\'Strike\',\'-\',\'RemoveFormat\' ] },\r\n\t\t            { name: \'clipboard\', items : [ \'Cut\',\'Copy\',\'Paste\',\'PasteText\',\'PasteFromWord\',\'-\',\'Undo\',\'Redo\' ] },\r\n\t\t            { name: \'editing\', items : [ \'Find\',\'Replace\',\'-\',\'SelectAll\',\'-\',\'Scayt\' ] },\r\n\t\t            \'/\',\r\n\t\t            { name: \'styles\', items : [ \'Styles\',\'Format\' ] },\r\n\t\t            { name: \'paragraph\', items : [ \'NumberedList\',\'BulletedList\',\'-\',\'Outdent\',\'Indent\',\'-\',\'Blockquote\' ] },\r\n\t\t            { name: \'insert\', items :[ \'Image\',\'Flash\',\'Table\',\'HorizontalRule\',\'Smiley\',\'SpecialChar\',\'PageBreak\',\'Iframe\' ] },\r\n\t\t            { name: \'links\', items : [ \'Link\',\'Unlink\',\'Anchor\' ] },\r\n\t\t            { name: \'tools\', items : [ \'Maximize\',\'-\',\'About\' ] }\r\n\t\t\t\t],\r\n\t\t\t\tremoveButtons: \'\'\r\n\t\t\t});\r\n\t\t</script>\r\n\r\n\t\t<div class="form-group" id="imageContainer">\r\n\t\t\t<label>Image</label>\r\n\t\t</div>\r\n\r\n\t\t<div class="submit">\r\n\t\t\t<button type="button" class="btn btn-success" id="submitTestimonial">Submit</button>\r\n\t\t</div>\r\n\t</fieldset>\r\n</form>';});

define('views/testimonials/admin_add',[
	'app',
...
define('routes/testimonialRouter',[
